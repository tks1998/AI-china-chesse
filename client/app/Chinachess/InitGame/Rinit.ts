...
export class InitGame {
    ...
    static RgetRedPieces() {
        ...
        return [
            new Piece('j1', random[0],1),
            new Piece('j2', random[1],1),
            new Piece('p1', random[2],1),
            new Piece('p2', random[3],1),
            new Piece('m1', random[4],1),
            new Piece('m2', random[5],1),
            new Piece('x1', random[6],1),
            new Piece('x2', random[7],1),
            new Piece('s1', random[8],1),
            new Piece('s2', random[9],1),
            new Piece('z1', random[10],1),
            new Piece('z2', random[11],1),
            new Piece('z3', random[12],1),
            new Piece('z4', random[13],1),
            new Piece('z5', random[14],1),
            new Piece('k', random[15],1)
        ];
    }
